...
router.route('/').get(verifyToken_1.default, course_controller_1.CourseControllers.getCourses).post((0, auth_1.default)(user_constant_1.USER_ROLE.ADMIN), course_controller_1.CourseControllers.createCourse);
// Course details
router.route('/:id').get(verifyToken_1.default, course_controller_1.CourseControllers.getCourse).put((0, auth_1.default)(user_constant_1.USER_ROLE.ADMIN), course_controller_1.CourseControllers.updateCourse).delete((0, auth_1.default)(user_constant_1.USER_ROLE.ADMIN), course_controller_1.CourseControllers.deleteCourse);
